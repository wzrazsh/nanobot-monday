...
def main() -> int:
    ...
    session = args.session or f"opencode-{task_id}"
    ...
    opencode_action = start_opencode_if_needed(session, args.workdir)
    ...
    save_state(state)
    append_log(task_id, f"start task session={session} session_action={session_action} opencode_action={opencode_action}")
    ...
    print(json.dumps({
        ...
        "opencode_action": opencode_action,
